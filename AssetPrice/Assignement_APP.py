...
#fig_latex("ER_weigts", aux, "BL optimum weights with no constraint")
...
#
#d_file("w_blc", round(pd.Series(y, index = weights.index)*100,4).to_frame("Weights"), "BL Weights with Constraint", longtable = True)
